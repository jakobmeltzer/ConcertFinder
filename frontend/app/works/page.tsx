...
const works: Work[] = [
  ...
  },
  {
    ...
    period: "Late Romantic",
    duration: "65–70 min",
    upcomingPerformances: 9,
  },
  {
    id: "bruckner-symphony-no-4",
    title: 'Symphony No. 4 "Romantic"',
    composer: "Anton Bruckner",
    period: "Late Romantic",
    duration: "65–70 min",
    upcomingPerformances: 11,
  },
  {
  ...
  },
  {
    ...
    period: "Classical",
    duration: "30–35 min",
    upcomingPerformances: 27,
  },
  {
    id: "sibeliius-symphony-no-5",
    title: "Symphony No. 5",
    composer: "Jean Sibelius",
    period: "Late Romantic",
    duration: "30–35 min",
    upcomingPerformances: 8,
  },
  {
    id: "sibelius-symphony-no-2",
    title: "Symphony No. 2",
    composer: "Jean Sibelius",
    period: "Late Romantic",
    duration: "45–50 min",
    upcomingPerformances: 14,
  },
  {
    id: "rachmaninoff-piano-concerto-no-2",
    title: "Piano Concerto No. 2",
    composer: "Sergei Rachmaninoff",
    period: "Late Romantic",
    duration: "30–35 min",
    upcomingPerformances: 22,
  },
  {
    id: "dvorak-symphony-no-9",
    title: 'Symphony No. 9 "From the New World"',
    composer: "Antonín Dvořák",
    period: "Romantic",
    duration: "40–45 min",
    upcomingPerformances: 19,
  },
  {
    id: "mozart-symphony-no-40",
    title: "Symphony No. 40",
    composer: "Wolfgang Amadeus Mozart",
    period: "Classical",
    duration: "25–30 min",
    upcomingPerformances: 35,
  },
];
    ...
    <main className="min-h-screen bg-[#f7f5f0] text-[#202020]">
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-6 md:px-10">
        ...
        <div className="hidden items-center gap-8 text-sm md:flex">
          <Link href="/works" className="text-[#202020]">
            Works
          </Link>

          <Link
            href="/cities"
            className="text-[#77736b] transition-colors duration-200 hover:text-[#202020]"
          >
            Cities
          </Link>
        ...
        <button className="text-sm text-[#666] md:hidden">Menu</button>
      </nav>
      ...
      <section className="mx-auto max-w-5xl px-6 pb-16 pt-20 md:px-10 md:pt-28">
        <div className="animate-fade-up">
          ...
          <p className="mt-7 max-w-xl text-base leading-7 text-[#77736b] md:text-lg">
            Search thousands of classical works and discover where they are
            being performed.
          </p>
        </div>
                            ...
                            <div className="flex shrink-0 items-center justify-between gap-6 md:justify-end">
                              <div className="text-left md:text-right">
                                <p className="text-sm text-[#666]">
                                  {work.upcomingPerformances}
                                </p>

                                <p className="mt-0.5 text-xs text-[#aaa69e]">
                                  upcoming{" "}
                                  {work.upcomingPerformances === 1
                                    ? "performance"
                                    : "performances"}
                                </p>
                              </div>
